namespace recipe
{
    public class DataContext
    {
        ...
        public DataContext()
        {
            ...
            {
                Name = "פסטה פרפקטו רוזה",
                Category = mean,
                DateAdded = new DateTime(2024, 1, 1),
                Difficulty = Difficult.medium,
                ImgUrl = "https://www.bishulim.co.il/sites/default/files/styles/home_stage_1500_700/public/srh_recipes/abdeb81766a4c30572e01d719f726308.jpg?h=820f05d7&itok=-fSrNi4V",
                PreparationTime = 15,
                User = user1,
            ...
            RecipeList.Add(new Recipe
            {
                Name = "עוגת שוקולד קלה ועשירה",
                Category = mean,
                DateAdded = new DateTime(2024, 1, 1),
                Difficulty = Difficult.pro,
                ImgUrl = "https://www.bishulim.co.il/sites/default/files/styles/home_stage_1500_700/public/srh_recipes/9811ad8b167f5ff94e47153006d8979b.jpg?h=de5f317d&itok=KAYu83Ph",
                PreparationTime = 15,
                User = user1,
                Ingredients = ingredients,
                Preparation = new List<string>(){ "בוחרים כלי הגשה וחוצים תותים בכמות מספקת לסידור בכלי.",
